(function () {
    ...
    leaderBoardRankController.$inject = ['$scope', '_CheckAuthentication', '_AjaxRequest', '_DataTableFactory']; // dependency injection

    function leaderBoardRankController($scope, _CheckAuthentication, _AjaxRequest, _DataTableFactory) {
